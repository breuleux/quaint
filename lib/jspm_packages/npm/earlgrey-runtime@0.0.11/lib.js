...
(function(process) {
  ...
  var _object_methods = {"hasProperty": function(prop) {
      return prop in this;
    }};
  var _array_methods = {
  ...
  var _function_methods = {
    ...
    "::repr": function(repr) {
      if (this["::egclass"]) {
        return simpleENode(".class", [simpleENode(".name", this["::name"]), mktable(this.prototype, repr)]);
      } else {
  ...
  [[Number, _number_methods], [String, _string_methods], [Boolean, _boolean_methods], [Array, _array_methods], [RegExp, _re_methods], [Function, _function_methods], [Object, _object_methods]].map(function(nm) {
  ...
  function ___match_error(value, pattern_text) {
    var err = ErrorFactory("match").createFrom(___match_error, (pattern_text ? "'" + pattern_text + "' c" : "C") + "ould not find a match for value '" + String(value) + "'", {value: value});
    throw err;
  }
  ...
  function getProperty(obj, prop, objname) {
    if (Object.hasProperty.call(obj, prop)) {
      ...
      throw ErrorFactory("no_property").createFrom(getProperty, "'" + (objname || obj.toString()) + "' does not have property '" + prop + "'");
    }
  }
  ...
  function object(pairs) {
    ...
    if (pairs.length === undefined)
      throw ErrorFactory("object").create("Argument to 'object' must be an array of pairs.");
  ...
  function equal(a, b) {
    if (a === b)
      return true;
    else if (typeof(a) === "number" || typeof(a) === "string" || typeof(a) === "boolean" || a === null || a === undefined)
      return false;
      ...
      return true;
    } else if (Object.getPrototypeOf(a) === null || (Object.getPrototypeOf(a) === Object.prototype && b !== undefined && b !== null && typeof(b) === "object" && (Object.getPrototypeOf(b) === null || Object.getPrototypeOf(b) === Object.prototype))) {
  ...
  function mktable(obj, repr) {
    ...
    for (var i = 0; i < it.length; i++) {
      var curr = it[i];
      ch.push(simpleENode(".assoc", [repr(curr[0]), repr(curr[1])]));
    }
      ...
      function process(x) {
        ...
        if (prev && !(x["::lightweight"] && x["::lightweight"]())) {
          ...
          if (x["::repr"]) {
            ...
            var rval = simpleENode(".instance", [simpleENode(".name", x.constructor["::name"]), mktable(x, subrepr)]);
  ...
  function clone(a) {
    if (a === undefined || a === null || typeof(a) === "number" || typeof(a) === "string" || typeof(a) === "boolean")
      return a;
  ...
  kaiser.register(ENode.prototype, {typeId: "earl-grey-runtime/ENode"});
})(require("process"));
