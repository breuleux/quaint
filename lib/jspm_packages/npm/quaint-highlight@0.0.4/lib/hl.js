...
require("earlgrey-runtime/5");var t0$4 = undefined;var quaint$0 = undefined;var tools$0 = undefined;var html$0 = undefined;var hl$0 = undefined;var main$0 = undefined;var $targ$0 = undefined;quaint$0 = require("quaint");tools$0 = getProperty(quaint$0, "tools", "quaint");html$0 = require("earlgrey-runtime/std/html");hl$0 = function hl(hljs$0, raw__minus__lang$0, code$0, inline$0, default__minus__language$0) {
  ...
  var tmp$0 = undefined;var current__minus__hljs$0 = undefined;var block__minus__rule$0 = undefined;var inline__minus__rule$0 = undefined;var options$1 = undefined;var __at___$0 = undefined;var options$0 = undefined;var $$67$0 = undefined;var $$68$0 = undefined;var t0$1 = undefined;var t1$0 = undefined;var t2$0 = undefined;var ph$1$0 = undefined;var t0$0 = undefined;var m$0$0 = undefined;m$0$0 = arguments;t0$0 = m$0$0.length;if (t0$0 >= 0) {
    ph$1$0 = Array.prototype.slice.call(m$0$0, 0);t0$1 = ph$1$0;t1$0 = t0$1.length;if (t1$0 >= 1 && t1$0 <= 2 && (t2$0 = t0$1[0], __at___$0 = t2$0, ___hasprop(t2$0, "isQuaintEngine") && (t2$0.isQuaintEngine ? true : false))) {
      ...
      }block__minus__rule$0 = function blockRule(engine$0, temp$0$0) {
        var t0$2 = undefined;var tmp$1 = undefined;var code$1 = undefined;var raw__minus__lang$1 = undefined;var lang$0 = undefined;var body$1 = undefined;t0$2 = temp$0$0;if (___hasprop(t0$2, "lang")) {
          lang$0 = t0$2.lang;
        } else {
          lang$0 = null;
        }if (___hasprop(t0$2, "body")) {
          body$1 = t0$2.body;
        } else {
          ___match_error(temp$0$0);
        }code$1 = tools$0.dedent(tools$0.rawRelative(body$1).replace(RegExp("^ *\\n", ""), ""));raw__minus__lang$1 = (tmp$1 = lang$0, tmp$1 === undefined || tmp$1 === null ? tmp$1 : tmp$1.raw().trim()) || "";return hl$0(current__minus__hljs$0, raw__minus__lang$1, code$1, false, options$0.defaultBlock || options$0.defaultLanguage || options$0["default"]);
      };inline__minus__rule$0 = function inlineRule(engine$1, temp$1$0) {
        var t0$3 = undefined;var tmp$2 = undefined;var code$2 = undefined;var raw__minus__lang$2 = undefined;var lang$1 = undefined;var body$2 = undefined;t0$3 = temp$1$0;if (___hasprop(t0$3, "lang")) {
          lang$1 = t0$3.lang;
        } else {
          lang$1 = null;
        }if (___hasprop(t0$3, "body")) {
          body$2 = t0$3.body;
        } else {
          ___match_error(temp$1$0);
        }code$2 = tools$0.shed(body$2).raw().replace(RegExp("\\\\+[{}()\\[\\]]", "g"), function (x$0) {
          return x$0.slice(1);
        });raw__minus__lang$2 = (tmp$2 = lang$1, tmp$2 === undefined || tmp$2 === null ? tmp$2 : tmp$2.raw().trim()) || "";return hl$0(current__minus__hljs$0, raw__minus__lang$2, code$2, true, options$0.defaultInline || options$0.defaultLanguage || options$0["default"]);
      };return __at___$0.registerRules((function () {
        var $$191 = {};$$191[ENode([], {}, ["\\maybe\\lang ", options$0.operatorBlock || "&", " \\body"]).toString()] = block__minus__rule$0;$$191[ENode([], {}, ["\\maybe\\lang ", options$0.operatorInline || "`", " \\body"]).toString()] = inline__minus__rule$0;$$191[ENode([], {}, [options$0.operatorBlock || "&", " \\body"]).toString()] = block__minus__rule$0;$$191[ENode([], {}, [options$0.operatorInline || "`", " \\body"]).toString()] = inline__minus__rule$0;return $$191;
      })());
    } else {
      if (t1$0 >= 0 && t1$0 <= 1) {
        if (0 >= t1$0) {
