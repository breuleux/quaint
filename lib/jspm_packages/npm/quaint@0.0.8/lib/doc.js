...
MapDocument$0.prototype.getValue = function(key$5) {
  var __at___$9 = undefined;
  var self$7 = undefined;
  __at___$9 = this;
  self$7 = this;
  return tools$0.toJSON(__at___$9.get(key$5));
};
MapDocument$0.prototype.toJSON = function toJSON() {
  var m$4 = undefined;
  var acc$1 = undefined;
  ...
  __at___$10 = this;
  self$8 = this;
  return object((acc$1 = [], temp$3 = null, m$4 = null, (function() {
    $3: for (var _iterator = __at___$10.entries()[Symbol.iterator](),
        _step; !(_step = _iterator.next()).done; ) {
      m$4 = _step.value;
      var k$0 = undefined;
      var v$0 = undefined;
...
SeqDocument$0 = ___extend(function() {
  ...
  if (!getChecker(SeqDocument$0)(this)) {
    __at___$11 = Object.create(SeqDocument$0.prototype);
  } else {
    __at___$11 = this;
  }
  __at___$11.resetFlags();
  $targ$17 = [];
  __at___$11.data = $targ$17;
  return __at___$11;
}, BasicDocument$0);
SeqDocument$0.prototype.register = function register(path$0, entry$0) {
  ...
  self$9 = this;
  $targ$18 = true;
  __at___$12.modified = $targ$18;
  if (entry$0 === undefined) {
    return deleteSorted$0(__at___$12.data, [path$0, entry$0], comparePathEntries$0);
  } else {
    if (equal(__at___$12.data.length, 0) || equal(comparePaths$0(path$0, send(send(__at___$12, "data", true), __at___$12.data.length - 1)[0]), 1)) {
      return __at___$12.data.push([path$0, entry$0]);
    } else {
      return insertSorted$0(__at___$12.data, [path$0, entry$0], comparePathEntries$0);
    }
  }
};
$targ$4 = function(path$1) {
  ...
  __at___$13 = this;
  self$10 = this;
  return __at___$13.register(path$1, undefined);
};
...
SeqDocument$0.prototype.entriesWithPaths = function entriesWithPaths() {
  ...
  self$11 = this;
  $targ$19 = true;
  __at___$14.accessed = $targ$19;
  return __at___$14.data.slice();
};
SeqDocument$0.prototype.entries = function entries() {
  ...
  self$12 = this;
  $targ$20 = true;
  __at___$15.accessed = $targ$20;
  acc$2 = [];
  temp$4 = null;
  m$5 = null;
  $4: for (var _iterator = __at___$15.data[Symbol.iterator](),
      _step; !(_step = _iterator.next()).done; ) {
    m$5 = _step.value;
    var e$0 = undefined;
    var t0$7 = undefined;
    var t1$5 = undefined;
    t0$7 = m$5;
    if (Array.isArray(t0$7) && (t1$5 = t0$7.length, t1$5 === 2)) {
      t0$7[0];
      e$0 = t0$7[1];
      temp$4 = e$0;
      acc$2.push(temp$4);
...
SeqDocument$0.prototype.entriesBefore = function entriesBefore(path$2) {
  ...
  self$13 = this;
  $targ$21 = true;
  __at___$16.accessed = $targ$21;
  acc$3 = [];
  temp$5 = null;
  m$6 = null;
  $5: for (var _iterator = __at___$16.data[Symbol.iterator](),
      _step; !(_step = _iterator.next()).done; ) {
    m$6 = _step.value;
    var p$0 = undefined;
    var e$1 = undefined;
    ...
    var t1$6 = undefined;
    t0$8 = m$6;
    if (Array.isArray(t0$8) && (t1$6 = t0$8.length, t1$6 === 2 && (p$0 = t0$8[0], e$1 = t0$8[1], comparePaths$0(p$0, path$2) < 0))) {
      temp$5 = e$1;
      acc$3.push(temp$5);
    } else {
      false;
...
SeqDocument$0.prototype.entriesAfter = function entriesAfter(path$3) {
  ...
  self$14 = this;
  $targ$22 = true;
  __at___$17.accessed = $targ$22;
  acc$4 = [];
  temp$6 = null;
  m$7 = null;
  $6: for (var _iterator = __at___$17.data[Symbol.iterator](),
      _step; !(_step = _iterator.next()).done; ) {
    m$7 = _step.value;
    var p$1 = undefined;
    var e$2 = undefined;
    ...
    var t1$7 = undefined;
    t0$9 = m$7;
    if (Array.isArray(t0$9) && (t1$7 = t0$9.length, t1$7 === 2 && (p$1 = t0$9[0], e$2 = t0$9[1], comparePaths$0(p$1, path$3) > 0))) {
      temp$6 = e$2;
      acc$4.push(temp$6);
    } else {
      false;
